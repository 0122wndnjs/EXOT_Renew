  ...
  return (
    <section className="relative w-full min-h-screen text-white py-24 px-6 overflow-hidden">
      ...
      <div className="relative w-full lg:max-w-[75%] mx-auto flex flex-col lg:flex-row items-start justify-between gap-16 lg:gap-20 z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-b from-[#fff5e0] to-[#ffe2a0]">
            MISSION
          </h2>
        ...
        >
          ...
          >
            <h3 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#fff5e0] to-[#ffe2a0]">
